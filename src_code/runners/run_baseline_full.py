...
def main():
    ...
    ap.add_argument("--fresh", action="store_true", help="Delete results/baseline_full_results.csv before running.")
            ...
            for N in feature_sizes:
                ...
                for seed in seeds_full:
                    ...
                    for case in cases_here:
                        ...
                        # 1) Build QUBO
                        run_cmd([py, "src_code/generators/build_qubo.py", "--scenario", str(scen_id), "--overwrite"], project_root)
                        ...
                        # 2) Solve classical
                        run_cmd([py, "src_code/solvers/solve_classical.py", "--scenario", str(scen_id)], project_root)
